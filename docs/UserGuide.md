...
Phone number(s) are recommended to meet the following guidelines, otherwise you will see a warning:
* It can contain only digits, spaces, '+' or '-' in the number part.
* Multiple phone numbers should be separated by commas. Otherwise, duplicate phone number warnings may not be detected correctly.
